    ...
    <div className="h-full w-full">
      ...
      <div className="flex w-full h-[45%] ">
        <div className="w-[58%] flex flex-col items-center h-full ">
          ...
          <div >
              <h1 className="text-3xl leading-[4rem] font-bold text-center opacity-70">Unlock leader boards !</h1>
              <h2 className="text-xl opacity-50 font-bold text-center">Complete 9 more lessons to start competing</h2>
          </div>
        </div>
