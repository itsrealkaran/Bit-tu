  ...
  return (
    <div className="h-full w-full">
      ...
      <div className="flex w-full h-[45%] ">
        ...
        <div className="w-[88%] h-[65%] rounded-2xl border-[2px] border-black/10 p-5">
          <h1 className=" font-extrabold opacity-40 text-sm tracking-tighter uppercase">what are leaderboards? </h1>

          <h2 className="text-lg font-extrabold w-[55%] leading-[1.5rem] mt-[6px]">Do lessons. Earn Xp. Compete.</h2>
          <p className="opacity-50 font-bold leading-[1.5rem] tracking-tight mt-2 text-md w-[68%]">Earn XP through lessons, then compete with players in a weekly leaderboard</p>
        </div>
        <div>
          <img className="" src="https://d35aaqx5ub95lt.cloudfront.net/images/leagues/071159d03311fcb556c4dfe730941de1.svg" alt="not showing" />
        </div>
        </div>
      </div>
