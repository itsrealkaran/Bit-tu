...
{/* this is the bottom part of the leader board  */}
   ...
   <RankingList name={"isagi yoichi"} rank={2} image={"https://picsum.photos/200/300"}/>
   <RankingList name={"arima kousie"} rank={3} image={"https://picsum.photos/200/300"}/>
   <RankingList name={"kuze kun"} rank={4} image={"https://picsum.photos/200/300"}/>
   <RankingList name={"maou san"} rank={5} image={"https://picsum.photos/200/300"}/>
   <RankingList name={"chitantsu sempai"} rank={6} image={"https://picsum.photos/200/300"}/>
