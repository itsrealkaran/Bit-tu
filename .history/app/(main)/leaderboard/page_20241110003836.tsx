    ...
    <div className="h-full w-full">
      ...
      <div className="flex w-full h-[45%] ">
        <div className="w-[58%] flex flex-col items-center h-full ">
          ...
          <div className="w-[42%] hover:items-center transition-all duration-1000 h-[15%] flex items-start pt-[1px] justify-center mt-5 bg-[#E5E5E5] rounded-xl">
            <div className="w-[98%] h-[92%] bg-white rounded-xl flex items-center justify-center">
              <h1 className="text-[#1CB0F6] font-extrabold tracking-wide text-lg uppercase">Start a Lesson</h1>
            </div>
          </div>
        </div>
