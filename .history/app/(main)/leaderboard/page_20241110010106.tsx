    ...
    <div className="h-full w-full">
      ...
      <div className="flex w-full h-[45%] ">
        ...
        <div className="w-[88%] h-[65%] rounded-2xl border-[2px] border-black/10 p-5">
          ...
          <p className="opacity-50 font-bold leading-[1.5rem] tracking-tight mt-2 text-md w-[65%]">Earn XP through lessons, then compete with players in a weekly leaderboard</p>
        </div>
        </div>
      </div>
