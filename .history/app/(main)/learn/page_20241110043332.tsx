    ...
    <div className='w-full h-full flex  '>
      ...
      <div className='w-[38%] h-full '>
        ...
        <div className="w-full flex flex-col items-center pl-5 gap-3 pt-[50px] h-full ">
          <div className="w-[100%] h-[30%] rounded-xl border-[2px] border-black/10">
            <div className="relative">
              <img src="https://d35aaqx5ub95lt.cloudfront.net/images/super/2e50c3e8358914df5285dc8cf45d0b4c.svg" alt="not showing" />
