   ...
   <>
          <div className="w-[62%] h-full  overflow-y-auto flex flex-col gap-2 ">
            <div className="w-full flex justify-center  h-[12%]">
              <div className="w-[97%] px-3 py-2 h-full text-white rounded-xl bg-[#58CC02]">
                <h1 className=" font-bold opacity-40">SECTION 1 , UNIT 1</h1>
                <h1 className="text-lg font-bold ">Discuss traveling solo</h1>
              </div>
            </div>
            <div className="flex-shrink-0 h-[80%] w-full bg-black"></div>
          </div>
   </>
      )}
