    ...
    <div className='w-full h-full flex  '>
      ...
      <div className='w-[62%] h-full '>
        <div className='w-full flex justify-center h-[13%] '>
              <div className='w-[90%] relative border-b-[2px] border-black/20'>
                <div className="flex h-full opacity-50  items-center gap-3">
                <ArrowLeft/>
                  <h1 className="text-xl font-extrabold opacity-50 ">Back</h1>
                </div>
              </div>
        </div>
      </div>
