    ...
    <div className='w-full h-full flex  '>
      ...
      <div className='w-[62%] h-full '>
        ...
        <div className="w-full h-[87%] overflow-y-auto pb-3 pt-8 flex flex-col gap-3 items-center">
         ...
         <SingleSection func={changeSection} BGcolor="#DDF4FF" number="1" para="I can participate in daily life in English." img="https://d35aaqx5ub95lt.cloudfront.net/images/pathSections/exampleSentences/801070f230984a26ae39fff41cbb1dc6.svg"/>
        ...
        <div className="w-full flex flex-col items-center pl-5 gap-5 pt-[50px] h-full ">
          <div className="w-[100%] p-3 h-[30%] rounded-xl border-[2px] border-black/10">
            ...
            <div className="relative">
              ...
              <div className="mt-5">
                ...
                <h2 className="text- w-[65%] font-bold opacity-50 mt-1">No ads, personalized practice, and unlimited Legendary!</h2>
              </div>
            ...
            <div className="w-full h-[35%] flex justify-center items-center">
              <div className="w-[90%] items-center text-sm font-extrabold uppercase tracking-wide rounded-xl flex h-[70%] bg-[#3C4DFF] text-white justify-center ">
                Try for Free
              </div>
            </div>
          ...
          <div className="w-full h-[20%] rounded-xl border-[2px] border-black/10 py-3 px-5">
            ...
            <div className="flex mt-5 gap-7 ">
              ...
              <p className="text-lg font-semibold opacity-60  ">Complete 9 more lessons to start competing</p>
            </div>
          </div>
          <div className="w-full h-[20%] rounded-xl border-[2px] border-black/10 py-3 px-5">
            <h1>Unlock Leaderboards!</h1>
