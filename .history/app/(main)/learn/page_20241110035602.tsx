    ...
    <div className='w-full h-full flex  '>
      ...
      <div className='w-[62%] h-full '>
        ...
        <div className="w-full h-[87%] overflow-y-auto pt-8 flex flex-col gap-3 items-center">
         ...
         <SingleSection number="1" para="I can participate in daily life in English." img="https://d35aaqx5ub95lt.cloudfront.net/images/pathSections/exampleSentences/801070f230984a26ae39fff41cbb1dc6.svg"/>
        </div>
      </div>
