    ...
    <div className='w-full h-full flex  '>
      ...
      <div className='w-[62%] h-full '>
        ...
        <div className="w-full h-[87%] overflow-y-auto pt-8 flex flex-col gap-3 items-center">
         ...
         <SingleSection BGcolor="#F7F7F7" number="2" para="I can express myself appropriately depending on the context." img="https://d35aaqx5ub95lt.cloudfront.net/images/pathSections/exampleSentences/7f2dfc9cc806971c2230c8f91b5b8bdd.svg"/>
        </div>
      </div>
