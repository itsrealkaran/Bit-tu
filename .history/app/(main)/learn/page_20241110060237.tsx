   ...
   <>
          <div className="w-[62%] h-full   overflow-y-auto flex flex-col gap-2 ">
            ...
            <div className="flex-shrink-0 relative h-[80%] w-full ">
              ...
              <div className="absolute w-[40%] h-[50%] top-1/2 -translate-y-1/2 right-0">
              <img className="w-full h-full object-cover " src="https://d35aaqx5ub95lt.cloudfront.net/images/pathCharacters/locked/34443969dabd59f00795cc94457c1b3b.svg" alt="not showign" />
              </div>
